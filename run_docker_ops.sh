...
usage() {
    echo "Usage: ./run_docker_ops.sh <ENVIRONMENT_NAME> [SCRIPT:bash] [OPS_DOCKER_IMAGE:midburn/sk8s-ops] <OPS_REPO_SLUG> [OPS_REPO_BRANCH:master] [OPS_SECRET_JSON_FILE:./secret-k8s-ops.json] [DOCKER_RUN_PARAMS]"
}
...
[ -z "${OPS_DOCKER_IMAGE}" ] && OPS_DOCKER_IMAGE="gcr.io/midbarrn/sk8s-ops@sha256:6c368f75207229c8bb2ccb99bd6414dfb21289c5c988d2381a9da2015f55bd38" \
                             && echo "OPS_DOCKER_IMAGE=${OPS_DOCKER_IMAGE}"
